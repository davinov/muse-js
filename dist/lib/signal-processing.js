...
function zipSamplesToTimeSeries(eegReadings, bufferSize, bufferOverlap) {
    return zipSamples(eegReadings).pipe(bufferCount_1.bufferCount(bufferSize, bufferOverlap), map_1.map(function (zippedReadings) {
        return {
...
//# sourceMappingURL=signal-processing.js.map